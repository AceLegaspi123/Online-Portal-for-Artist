  ...
  const recentlyLiked = [
    {
      ...
      likes: 428,
      image: "https://i.pinimg.com/736x/aa/47/a5/aa47a5df10aa9dbe16f56ba7eb3b95db.jpg",
    },
    {
      title: "Ethereal Bloom",
      category: "Painting",
      likes: 312,
      image: "https://i.pinimg.com/1200x/a1/89/85/a189854911a37f572a76ebb31b7c4446.jpg",
    },
    {
      title: "Cyber Cityscape",
      category: "Pixel Art",
      likes: 250,
      image: "https://i.pinimg.com/736x/fc/e9/e3/fce9e33a03fcad649f072f0731d99040.jpg",
    },
    {
      title: "Serene Waters",
      category: "Photography",
      likes: 180,
      image: "https://i.pinimg.com/736x/da/6b/19/da6b19742a9bf64674215b6faa5893c9.jpg",
    },
  ];
  ...
  const topArtists = [
    {
      ...
      artworks: 1200,
      avatar: "https://i.pinimg.com/1200x/c9/70/79/c9707949e969fd0c80bb6d3c6eae2ae7.jpg",
    },
    {
      name: "Seraphina Wynter",
      username: "@seraphinamae_wynter",
      artworks: 1096,
      avatar: "https://i.pinimg.com/736x/07/f0/78/07f078f3f067607c62b1739d39fc30a7.jpg",
    },
    {
      name: "Quinn Turner",
      username: "@quinnvertyy_turnermoon",
      artworks: 980,
      avatar: "https://i.pinimg.com/736x/59/45/8f/59458f89a8df4ab7472a06fcfbf223da.jpg",
    },
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="hidden lg:block relative h-[50dvh]">
            <div className="absolute top-0 right-0 w-64 h-80 bg-zinc-800 rounded-2xl rotate-6 border border-white/10 shadow-2xl overflow-hidden">
              <img src="https://i.pinimg.com/1200x/59/bc/da/59bcda390ffb99e694e56b274b09b471.jpg" className="w-full h-full bg-gradient-to-br from-zinc-700 to-zinc-900" />
            </div>
            <div className="absolute top-20 right-40 w-64 h-80 bg-zinc-800 rounded-2xl -rotate-12 border border-white/10 shadow-2xl z-20 overflow-hidden">
              <img src="https://i.pinimg.com/1200x/9d/23/42/9d2342b3dab4d521c58384932e179df8.jpg" className="w-full h-full bg-primary/20" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 lg:px-20 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {topArtists.map((data, i) => (
            <div key={i} className="group relative p-6 rounded-2xl bg-primary border border-zinc-800 hover:border-[#00d26a]/50 transition-all hover:bg-zinc-900/50">
              <div className="flex items-center gap-4">
                <div className="relative">
                  <div className="w-16 h-16 rounded-full bg-gradient-to-tr from-[#00d26a] to-blue-500 p-[2px]">
                    <div className="w-full h-full rounded-full bg-black overflow-hidden">
                      {/* Avatar Placeholder */}
                      <img src={data.avatar} className="w-full h-full bg-zinc-800 animate-pulse" />
                    </div>
                  </div>
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-lg group-hover:text-[#00d26a] transition-colors">{data.name}</h4>
                  <p className="text-xs text-zinc-500 font-medium">{data.username} • {data.artworks.toLocaleString()} Artworks</p>
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {recentlyLiked.map((data, i) => (
              <div key={i} className="group relative aspect-[4/5] rounded-3xl overflow-hidden bg-zinc-900 border border-white/5">
                {/* Image Placeholder */}
                <img src={data.image} className="absolute inset-0 bg-zinc-800 group-hover:scale-110 transition-transform duration-700" />
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity p-6 flex flex-col justify-end">
                  <div className="flex justify-between items-center">
                    <div>
                      <p className="text-xs font-bold text-[#00d26a] uppercase mb-1">{data.category}</p>
                      <h5 className="font-bold text-white">{data.title}</h5>
                    </div>
                    <div className="flex flex-col items-center gap-1">
                      <Heart size={18} className="text-red-500" fill="currentColor" />
                      <span className="text-[10px] font-bold">{data.likes.toLocaleString()}</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-24 px-6 lg:px-20 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-4 grid-rows-2 gap-4 h-[600px]">
          ...
          <div className="col-span-2 row-span-1 relative rounded-3xl bg-zinc-900 overflow-hidden group border border-white/5">
            {/* Gradient overlay */}
            <img src ="https://i.pinimg.com/1200x/a9/15/23/a91523e3be6d16dafb2355d9a40696ae.jpg" className="object-cover transition-transform duration-700 group-hover:scale-110" />
            <div className="absoluteabsolute inset-0 bg-gradient-to-t from-black/60 to-transparent z-10"/>
            <div className="absolute bottom-6 left-6 z-20 text-lg font-bold text-white">Concept Art</div>
          </div>

          <div className="col-span-1 row-span-1 relative rounded-3xl bg-zinc-900 overflow-hidden group border border-white/5">
            {/* Gradient overlay */}
            <img src = "https://i.pinimg.com/736x/b9/b9/fb/b9b9fbf45fd39537d599e5e39be34020.jpg" className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-110"/>
            <div className="bsolute inset-0 bg-gradient-to-t from-black/60 to-transparent z-10"/>
            <div className="absolute bottom-6 left-6 z-20 text-lg font-bold text-white">Pixel</div>
          </div>
