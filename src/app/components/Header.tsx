...
export default function Header() {
  return (
    <header className="relative border-b-1 border-b-primary-line flex w-full justify-center items-center mb-10 p-4">
      ...
      <Link href="/"><Logo/></Link>
        ...
        <div className="flex relative">
          ...
          <input
            ...
            className="bg-secondary opacity-80 font-normal py-4 pl-14 w-[21rem] rounded-full"
          />
        </div>
