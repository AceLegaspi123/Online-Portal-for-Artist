...
const Commission = () => {
  return (
    <main className="max-w-[1880px] mx-auto md:px-10">
      <h1 className="text-3xl font-bold">My Commission <span className="text-green-500">Requests</span></h1>
      <p className="text-sm opacity-80">Track the status of your commission requests to artists</p>
