...
export default function Header() {
  ...
  console.log(isLogin);
  return (
    <header className="z-20 bg-background sticky top-0 h-20 left-0 w-full border-b-1 border-b-primary-line flex justify-between items-center mb-10 px-5 md:px-10 lg:px-20">
